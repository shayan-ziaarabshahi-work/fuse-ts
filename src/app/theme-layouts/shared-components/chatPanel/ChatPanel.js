...
function ChatPanel(props) {
  ...
  const contacts = useFuseSelector(selectContacts);
  const selectedContactId = useFuseSelector(selectSelectedContactId);
  const state = useFuseSelector(selectChatPanelState);
